                ...
                <main class="main">
                    <div class="col-lg-10 col-lg-offset-1">
                        <article class="hentry post post-standard-details">
                                    ...
                                    <div class="widget w-tags">
                                        <div class="tags-wrap">
                                           ...
                                           @foreach ($post->tags as $tag)
                                                <a href="{{ route('template.tag', ['id'=>$tag->id]) }}" class="w-tags-item">{{$tag->tag}}</a>
                                           @endforeach
                            ...
                            <div class="socials text-center">{{__('Share')}}:
                        ...
                        <div class="blog-details-author">
                            ...
                            <div class="blog-details-author-thumb">
                                <img src="{{asset( $post->user->profile['avatar'])}}" alt="Author" class="img-responsive img-thumbnail" style=" border-radius: 50%">
                            </div>
                    ...
                    <a href="{{ route('post.single', ['slug'=>$next->slug]) }}" class="btn-prev-wrap">
                         ...
                         <div class="btn-content">
                             <div class="btn-content-title">Article Précedant</div>
                    ...
                    @endif
                        ...
                        <div class="comments">
                            ...
                            <div class="heading text-center">
                                <h4 class="h1 heading-title">Commentaires</h4>
                    ...
                    <div class="col-lg-12">
                        <aside aria-label="sidebar" class="sidebar sidebar-right">
                            <div  class="widget w-tags">
                                <div class="heading text-center">
                                    <h4 class="heading-title">TOUTES LES ETIQUETTES</h4>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
