                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="{{ route('template.category', ['id'=>$first_post->category->id]) }}">{{$first_post->category->name}}</a>
                                        </span>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{$third_post->featured}}" alt="{{$second_post->title}}">
                        <div class="overlay"></div>
            ...
            <div class="container">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{$tech->name}}</h4>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                           ...
                           @foreach ($tech->posts()->take(3)->get() as $post)
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            {{-- <div class="heading">
                                <h4 class="h1 heading-title">{{$bootstrap->name}}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    <div class="row">
                        {{-- <div class="case-item-wrap">
                            ...
                            @foreach ($bootstrap->posts()->take(3)->get() as $post)
